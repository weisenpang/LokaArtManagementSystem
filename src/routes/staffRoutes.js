...
import { editUser, deleteUser } from "../controllers/userManagementController.js";
...
staffRouter.patch('/:id/edit-user',editUser);
staffRouter.delete('/:id/delete-user',deleteUser);
